        ...
        <div className="relative pt-24 lg:pt-28">
          <div className="mx-auto px-6 max-w-7xl md:px-12">
            <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
              ...
              <h1 className="mt-8 text-wrap text-4xl md:text-5xl font-bold text-gray-950 dark:text-white xl:text-7xl xl:[line-height:1.125] tracking-tight">
                World&apos;s first 🥇 <br className="hidden sm:block" /> Smart
                Aid Glasses for
              </h1>
              <div className="text-wrap mx-auto mt-8 max-w-2xl text-lg text-gray-700 dark:text-gray-300 flex items-center justify-center gap-3 flex-wrap">
                <span className="border border-gray-200   rounded-full px-2 flex items-center">
                  ...
                  <p className="font-semibold">Deaf</p>
                </span>
                <span className="border border-gray-200   rounded-full px-2 flex items-center">
                  <svg
                    stroke="currentColor"
                ...
                <span className="border border-gray-200   rounded-full px-2 flex items-center">
                  ...
                  <p className="font-semibold">Blind</p>
                </span>
              </div>
              <p className="text-wrap mx-auto mt-6 max-w-2xl text-gray-700 dark:text-gray-300">
                The Able glasses uses patented bone conduction to enable Deaf to
                Listen, interpret signs & acts as voice assist tool for the
                mute, the sensory audio-based information enables the blind to
                visualize.
              </p>
