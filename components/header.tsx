  ...
  return (
    <>
       <header>
        ...
        <div className='mx-auto flex items-center justify-between bg-green-200/35 md:px-[13rem] px-0 flex-wrap sm:whitespace-nowrap py-1'>
              <span>📞 Call us | <strong>+91 9373124725</strong></span>
              <span>📩 Email | <strong>kshaminnovation@gmail.com</strong></span>
           </div>
                    ...
                    <div className="w-full h-0 lg:w-fit flex-wrap justify-end items-center space-y-8 lg:space-y-0 lg:flex lg:h-fit md:flex-nowrap">
                        <div className="mt-6 text-gray-600 dark:text-gray-300 md:-ml-4 lg:pr-4 lg:mt-0">
                            <ul className="space-y-6 tracking-wide text-base lg:text-sm lg:flex lg:space-y-0">
                                <li>
                                    <Link href="/" className="block md:px-4 transition hover:text-primary-600 dark:hover:text-primary-400">
                                        <span>Home</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/aboutus" className="block md:px-4 transition hover:text-primary-600 dark:hover:text-primary-400">
                                        <span>About us</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/docs" className="block md:px-4 transition hover:text-primary-600 dark:hover:text-primary-400">
                                        <span>Docs</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/contact" className="block md:px-4 transition hover:text-primary-600 dark:hover:text-primary-400">
